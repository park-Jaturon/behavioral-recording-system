...
class PersonalRecordController extends Controller
{
    ...
    public function exportPDF()
    {
        ...
        // --------------------------------------------------------------------------------------------
        $pdf::MultiCell(36, 183, '<u>พัฒนาการด้านร่างกาย</u><br/> มาตรฐานที่&nbsp;1&nbsp;<br/>ร่ายกายเจริญเติบโต<br/>ตามวัยและมีสุขนิสัยที่ดี', 1, 'L', false, 0, '', '', true, 0, true, true, 33, 'T');
        ...
        $pdf::MultiCell(32, 98, '2.<br/>มีสุขภาพอนามัยสุขนิสัยที่ดี', 1, 'C', false, 0, 46, '', true, 0, true);
        ...
        $pdf::MultiCell(62, 16, '2.4 ออกกำลังกายเป็นเวลา', 1, 'L', false, 0, 78, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, 140, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 1, '', '', true, 0, true);
        $pdf::MultiCell(62, 16, '2.5 อาบน้ำแต่ตัวได้แต่ไม่คล่อง', 1, 'L', false, 0, 78, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, 140, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 1, '', '', true, 0, true);
        $pdf::MultiCell(62, 16, '2.6 ขับถ่ายเป็นเวลา', 1, 'L', false, 0, 78, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, 140, '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 16, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        ...
        $pdf::MultiCell(36, 75, '<u>พัฒนาการด้านอารมณ์  และจิตใจ</u><br/>มาตรฐานที่&nbsp;4&nbsp;<br/>ชื่นชมและแสดงออก ทางศิลปะ ครตรี และการเคลื่อนไหว', 1, 'L', false, 0, '', '', true, 0, true, true, 33, 'T');
        $pdf::MultiCell(32, 75, '1.<br/>สนใจมีความสุขและแสดงออกผ่านงาน<br/>ศิลปะคนตรีและการเคลื่อนไหว', 1, 'C', false, 0, '', '', true, 0, true);
        ...
        $pdf::MultiCell(10, 17, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 0, '', '', true, 0, true);
        $pdf::MultiCell(10, 17, '<img src=".\image\check-mark-2025986.svg" width="10" height="15">', 1, 'C', false, 1, '', '', true, 0, true);
        $pdf::MultiCell(62, 24, '1.3 สนใจมีความสุขและแสดงท่าทาง/<br/>เคลื่อนไหวประกอบเลงจังหวะและดนตรี', 1, 'L', false, 0, 78, '', true, 0, true);
