        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                @if (count($table1_semester1) > 0 &&
                        count($table1_semester2) > 0 &&
                        count($table2_semester1) > 0 &&
                        count($table2_semester2) > 0 &&
                        count($table3_semester1) > 0 &&
                        count($table3_semester2) > 0 &&
                        count($table4_semester1) > 0 &&
                        count($table4_semester2) > 0 &&
                        count($table5_semester1) > 0 &&
                        count($table5_semester2) > 0 &&
                        count($table6_semester1) > 0 &&
                        count($table6_semester2) > 0 &&
                        count($table7_semester1) > 0 &&
                        count($table7_semester2) > 0 &&
                        count($table8_semester1) > 0 &&
                        count($table8_semester2) > 0 &&
                        count($table9_semester1) > 0 &&
                        count($table9_semester2) > 0 &&
                                            ...
                                            <tbody class="semester1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @error('developments_behavior1_1_2')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                        @enderror
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class=" text-center" valign="middle"
                                                        ...
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="semester" required
                                                            onChange="selectSemester('table4', event)"
                                                            data-parsley-required-message="กรุณาเลือกภาคเรียน">
                                                            <option selected disabled>-- ภาคเรียนที่ --</option>
                                                            @if ($check_table_semester1 == false && $check_table_semester2 == false)
                                                                <option value="ภาคเรียน1">ภาคเรียน 1</option>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody class="semester5">
                                                ...
                                                <tr>
                                                    <td>
                                                        1.4
                                                        ระมัดระวังดูแลตนเองและผู้อื่นให้ปลอดภัยโดยมีผู้อื่นคอยตักเตือนบ้าง
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class=" text-center" valign="middle">พฤติกรรม
                                                    </th>
                                                    <th scope="col" class=" text-center" valign="middle"
                                                        width="200px">
                                                        <select class="form-select" aria-label="Default select example"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <select class="form-select" aria-label="Default select example"
                                                            ...
                                                            name="developments_behavior7_1_2" required
                                                            data-parsley-required-message="ยังไม่ได้ประเมิน">
                                                            <option value="" selected disabled>-- พัฒนาการ --
                                                            </option>
                                                            <option value="1">ควรเสริม</option>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody class="semester8">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        1.1
                                                        บอกลักษณะส่วนประกอบของสิ่งของต่างๆจากกการสังเกตโดยใช้ประสาทสัมผัส
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        2.1
                                                        ระบุสาเหตุหรือผผลที่เกิดขึ้นในเหตุการณ์หรือการกระทำเมื่อมีผู้ชี้แนะ
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class=" text-center" valign="middle"
                                                        ...
                                                        <select class="form-select" aria-label="Default select example"
                                                            name="semester" required
                                                            onChange="selectSemester('table9', event)"
                                                            data-parsley-required-message="กรุณาเลือกภาคเรียน">
                                                            <option selected disabled>-- ภาคเรียนที่ --</option>
                                                            @if ($check_table_semester1 == false && $check_table_semester2 == false)
                                                                <option value="ภาคเรียน1">ภาคเรียน 1</option>
                                        ...
                                        <div class="row justify-content-center align-items-center g-2 mb-3">
                                            ...
                                            <div class="col text-end">
                                                ...
                                                <select class="form-select float-end"
                                                    ...
                                                    required onChange="selectSemester('table10', event)"
                                                    data-parsley-required-message="กรุณาเลือกภาคเรียน"
                                                    style="width: 200px;">
                                                    <option selected disabled>-- ภาคเรียนที่ --</option>
                                                    @if ($check_table_semester1 == false && $check_table_semester2 == false)
