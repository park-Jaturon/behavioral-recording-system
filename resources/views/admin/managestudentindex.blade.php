                        ...
                        @foreach ($student as $students)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning "href="{{ url('admin/student/edit/' . $students->student_id) }}"role="button">แก้ไข</a>
                                </td>
                                <td>
                                    <div class="d-grid gap-2">
                                        <button type="button" 
                                            class="btn btn-danger delete-item"  data-student_id="{{$students->student_id}}">ลบ</button>
