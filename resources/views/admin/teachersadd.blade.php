                    ...
                    <form action="{{route('store.teacher')}}" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row justify-content-center align-items-center g-3 mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="firstname" id="firstname" value="{{old('firstname')}}" class="form-control"> {{--,$teachers->first_name--}}
                        </div>
                        <div class="col">
                            <label for="lastname" class="form-label">นามสกุล</label>
                            <input type="text" name="lastname" id="lastname" class="form-control" value="{{old('lastname')}}"> {{--,$teachers['last_name']--}}
                        </div>
                    </div>
                     ...
                     <div class="row justify-content-center align-items-center g-3 mb-3">
                        <div class="col">
                            ...
                            <select class="form-select" name="rankteacher"  aria-label="Default select example">
                                <option selected  >{{ old('--ตำแหน่ง--') }}</option>  
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" name="room"  aria-label="Default select example">
                                <option selected  >{{ old("--ห้อง--") }}</option> 
