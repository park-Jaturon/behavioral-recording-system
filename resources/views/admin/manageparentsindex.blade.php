                    ...
                    @foreach ($parent as $parents)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning "href="{{ url('admin/parent/edit/' . $parents->parents_id) }}"role="button">แก้ไข</a>
                            </td>
                            <td>
                                <div class="d-grid gap-2">
                                    <button type="button" 
                                        class="btn btn-danger delete-item"  data-parents_id="{{$parents->parents_id}}">ลบ</button>
